    ...
    <div className='w-full min-h-10 p-5 rounded-xl bg-black-main-one border border-orange-yellow-crayola/20' style={{ boxShadow: "0 16px 30px hsla(0, 0%, 0%, 0.25)" }}>
      <div className='w-full flex items-center justify-center'>
        ...
        <div className='w-full flex flex-col items-start text-left'>
          <h4 className='text-white-two font-medium capitalize text-base lg:text-lg mb-2'>{service}</h4>
          <p className='text-light-gray-70 leading-6 font-light text-xs lg:text-sm'>{description}</p>
        </div>
      </div>
    </div>
  )
